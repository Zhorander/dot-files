...
if s:extraConceal
    ...
    " My conceals
    " syntax match ocamlNiceOperator "for_all" conceal cchar=∀
    syntax match ocamlNiceOperator "List.for_all" conceal cchar=∀
    syntax match ocamlNiceOperator "exists" conceal cchar=∃
    syntax match ocamlNiceOperator "List.exists" conceal cchar=∃
    syntax match ocamlNiceOperator "&&" conceal cchar=∧
    syntax keyword ocamlNiceOperator lxor conceal cchar=⊕
    syntax keyword ocamlNiceOperator not conceal cchar=¬
