...
address="https://api.darksky.net/forecast/READ THE COMMENT ABOVE?units=us&exclude=minutely,hourly,daily,alerts,flags"
#weather="$(get -q -O- $address)"
weather="$(GET $address)"
